...
#ifndef SRC_LIBRARIES_FT_FTCALCluster_FACTORY_ENECORRHDBSCAN_H_
#define SRC_LIBRARIES_FT_FTCALCluster_FACTORY_ENECORRHDBSCAN_H_

#include "JANA/JFactoryT.h"
#include "FTCalCluster.h"

class FTCalCluster_factory_EneCorrHdbscan: public JFactoryT<FTCalCluster> {
public:
	FTCalCluster_factory_EneCorrHdbscan();
	virtual ~FTCalCluster_factory_EneCorrHdbscan();
