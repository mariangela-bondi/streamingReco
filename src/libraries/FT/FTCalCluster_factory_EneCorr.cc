...
int minClusterSize_EneCorr = 3; //Need size >= to min for accept cluster.
double minClusterEnergy_EneCorr = 300; //Need size > to min for accept cluster. Not >=.
double minSeedEnergy_EneCorr = 50;
