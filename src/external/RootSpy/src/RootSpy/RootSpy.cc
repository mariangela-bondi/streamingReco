...
extern std::string CMSG_NAME;
extern std::string ROOTSPY_UDL;

extern std::string ELOG_NAME;
extern std::string ELOG_EMAIL;
extern bool ELOG_NOTIFY;

extern std::string CONFIG_FILENAME;
extern std::string INPUT_ROOT_FILENAME;
extern std::string PLUGINS_STR;
