...
#define R__DICTIONARY_FILENAME srcdIexternaldIRootSpydIsrcdIdOdODarwin_x86_64dIRootSpydIDialog_SelectTree_Dict
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const map<tree_id_t,TGListTreeItem*>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("map<tree_id_t,TGListTreeItem*>", -2, "map", 899,
