...
#define R__DICTIONARY_FILENAME srcdIexternaldIRootSpydIsrcdIdOdODarwin_x86_64dIRootSpydIDialog_SelectHists_Dict
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<hid_t>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("vector<hid_t>", -2, "vector", 470,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const map<string,bool>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("map<string,bool>", -2, "map", 899,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const map<hid_t,TGListTreeItem*>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("map<hid_t,TGListTreeItem*>", -2, "map", 899,
